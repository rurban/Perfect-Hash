...
C<crc32_zlib>, C<fnv>, C<crc32_sse42>, C<aes>, C<GFMultilinear>...

Only useful for hardware assisted C<crc32>, C<aes> and more C<xmm> system
...
generated code. As with L<gperf> C<--pic>
...
F<script/pperf> for the frontend.
